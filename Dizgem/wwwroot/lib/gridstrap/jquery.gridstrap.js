    ...
    1: [function (require, module, exports) {
        ...
        (function ($, window, document) {
            ...
            $.Gridstrap.defaultOptions = {
                ...
                draggedFinish: function draggedFinish($element) {
                    return $element;
                }
            ...
            function () {
                ...
                _createClass(Methods, [{
                    ...
                    value: function updateVisibleCellCoordinates() {
                        ...
                        options.draggedFinish.call(context, _this.setup.$el.children());
        ...
        var Setup =
            ...
            function () {
                function Setup($, window, document, $el, context) {
                    ...
                    $(options.visibleCellContainerParentSelector).append('<div id="' + wrapperGeneratedId + '" class="' + options.visibleCellContainerClass + ' row"></div>');
                    this.window = window;
                    this.document = document;
                    this.$ = $;
                    this.$el = $el;
