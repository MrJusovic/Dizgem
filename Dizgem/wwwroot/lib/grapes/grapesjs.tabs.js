        ...
        , function (t, e, n) {
                    ...
                    model: {
                        ...
                        __initTab: function () {
                            if (!this.tabContent) {
                                ...
                                if (!t) {
                                    var e, n = (t = this.getTabsType().getContentsType().append({
                                        type: i.typeTabContent,
                                        components: i.templateTabContent(this)
                                    })[0]).getId(), r = this.getId();
                                    t.addAttributes({
                                        id: n,
                                        'aria-labelledby': r,
                                        hidden: !0
                    ...
                    model: {
                        defaults: l({
                            ...
                            script: function (t) {
                                ...
                                (v = v || (n = (u.hash || '').replace('#', '')) && O(r, (e = a,
                                    "".concat(b, "[").concat(e, "=").concat(n, "]"))) || O(r, b)) && h(v),
                        ...
                        addTab: function (t) {
                            this.getTabContainerType().append({
                                type: n,
                                components: t
                            })
                        }
            ...
            var w = function (t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                    , n = t.DomComponents
                    , r = P(P({}, e), {}, {
                        defaultModel: n.getType('default').model,
                        editor: t
                    });
